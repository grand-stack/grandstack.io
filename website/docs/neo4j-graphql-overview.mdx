...
<img alt="Neo4j GraphQL logo" src={useBaseUrl('assets/img/neo4j-graphql-logo.png')} />
...
There are two versions of the Neo4j-GraphQL integrations: [`neo4j-graphql-js`](neo4j-graphql-js.mdx) and the [Neo4j-GraphQL database plugin](neo4j-graphql-database-plugin.mdx):
