...
| **Temporal fields**     |                         |                             | _Temporal filters use the temporal inputs described in the [Temporal Types (DateTime) section](graphql-temporal-types-datetime.md#using-temporal-fields-in-mutations)_ |
...
| **Spatial fields**      |                         |                             | _Spatial filers use the point inputs described in the [Spatial Types section](graphql-spatial-types.md)_                                                               |
