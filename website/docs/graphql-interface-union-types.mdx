...
<img alt="Property graph model" src={useBaseUrl('assets/img/interface-model.png')} />
...
<img alt="Simple movie graph with inteface" src={useBaseUrl('assets/img/interface-data.png')} />
...
<img alt="Union data in Neo4j" src={useBaseUrl('assets/img/union-data.png')} />
