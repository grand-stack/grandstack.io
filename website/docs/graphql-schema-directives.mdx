...
| `@id`               |                     | Used on fields to (optionally) specify the field to be used as the ID for the type                                                           |  |
| `@unique`           |                     | Used on fields to (optionally) specify fields that should have a uniqueness constraint.                                                      |  |
| `@index`            |                     | Used on fields to indicate an index should be created on this field.                                                                         |  |
