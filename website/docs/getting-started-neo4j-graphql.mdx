...
where `myapp` is the name of the application to be created. You can also use the [GraphQL Architect](low-code-graphql-architect-overview.mdx) low-code tool with Neo4j Desktop to create GraphQL APIs backed by Neo4j without writing any code.
