...
This approach can be used to define custom logic for Mutation fields as well. See the [guide for custom logic](https://grandstack.io/docs/graphql-custom-logic) for further examples of the `@cypher` directive.
